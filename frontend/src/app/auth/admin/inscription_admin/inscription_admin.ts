...
import { AuthAdminService, RegisterAdminData } from '../auth_admin.service';
...
@Component({
  ...
  templateUrl: './inscription_admin.html',
})
export class InscriptionAdmin {
    adminData: RegisterAdminData = {
            nom_complet: '',
            email: '',
            telephone: '',
            mdp: '',
    ...
    onSubmit() {
        if (this.adminData.mdp !== this.adminData.confirmPassword) {
